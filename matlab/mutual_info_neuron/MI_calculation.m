...
for x = 1:nreps % loop through all repetitions
     ...
     response_probs = sort(countmember(unique(words),words),'descend')/length(responsewords); % vector of the word probabilities present in the column
