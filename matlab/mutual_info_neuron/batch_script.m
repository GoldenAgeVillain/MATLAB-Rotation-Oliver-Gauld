...
for pp = 1:length(noise_scale_factors)
    ...
    for p = 1:length(gsyn_scale_factors)
        ...
        for i = 1:nreps   
            ...
            [data, data_AP, APfreq, current,spiketrain, gsyn, gNa_synapse, gNa_wholecell, gNoise, gTotal, SynNaCurr, wholecell_Na_current,syntotalcurrent] = neuron_model(0,noise_scaler,gsyn_scaler);
